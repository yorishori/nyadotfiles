...
-- Apps
hl.bind("SUPER + ESCAPE",         hl.dsp.exec("nyhud.sh rofi session"))
hl.bind("SUPER + SHIFT + ESCAPE", hl.dsp.exec("nylaunch.sh btop"))
hl.bind("SUPER + SPACE",          hl.dsp.exec("nyhud.sh rofi launcher"))
hl.bind("SUPER + V",              hl.dsp.exec("nyhud.sh rofi clipboard"))
hl.bind("SUPER + PERIOD",         hl.dsp.exec("nyhud.sh rofi emoji"))
hl.bind("SUPER + B",              hl.dsp.exec("zen-bin"))
hl.bind("SUPER + Y",              hl.dsp.exec("kitty -e yazi ~/Downloads/"))
...
hl.bind("SUPER + SHIFT + UP", hl.dsp.window.move("u"))
hl.bind("SUPER + SHIFT + DOWN", hl.dsp.window.move("d"))
hl.bind("SUPER + SHIFT + LEFT", hl.dsp.window.move("l"))
hl.bind("SUPER + SHIFT + RIGHT", hl.dsp.window.move("r"))
